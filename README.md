...
1. Respostas de conteudo da cliente (endereco, CNPJ, horario, raio de entrega,
   faturamento, prazo de entrega)
2. Container GTM real no lugar do placeholder
3. Dominio proprio e canonical
4. Trocar `noindex` por `index` na subida definitiva
